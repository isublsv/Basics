...
public class AccountRunner {
	...
	public static void main(String[] args) {
		...
		System.out.println("Total balance from accounts with only negative balances = "
				+ client.getOnlyNegativeBalances());

		System.out.println("Total balance from account with only positive balances = "
				+ client.getOnlyPositiveBalances());
